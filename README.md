**Usage Instructions:** Open index.html with a browser. Refreshing the page will regenerate the maze and calculate the optimal path, which will be marked in purple<br>
